...
/* ─── Palette ─── */
const BRAND = "#7ed957";
const BRAND_DIM = "rgba(126,217,87,0.15)";
const BRAND_BORDER = "rgba(126,217,87,0.5)";
const BRAND_BORDER_DIM = "rgba(126,217,87,0.3)";
const BG = "#000000";
    ...
    <AbsoluteFill style={{ pointerEvents: "none" }}>
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(126,217,87,0.22) 0%, rgba(126,217,87,0.05) 40%, transparent 65%)",
          filter: "blur(160px)",
        }}
      />
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(126,217,87,0.12) 0%, transparent 70%)",
          filter: "blur(100px)",
        }}
      />
    </AbsoluteFill>
  ...
  return (
    ...
    >
      <div style={{ transform: `scale(${logoScale})`, opacity: logoOpacity }}>
        <Img src={staticFile("logos/rompiendo-limites.png")} style={{ width: 700, height: "auto" }} />
      </div>
...
const SceneAltaUsuario: React.FC = () => {
  ...
  const emailAText = typewriter("carla.mendez@rompiendolimites.com", frame, 65, 3);
  ...
  const emailBText = typewriter("tomas.lopez@rompiendolimites.com", frameBLocal, 52, 3);
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 12, opacity: extrasOpacity, transform: `translateY(${extrasY}px)` }}>
                    ...
                    <div>
                      ...
                      <div style={{ ...inputBase, justifyContent: "space-between" }}>
                        <span>Personalizado (WODs + RMs)</span>
                        <span style={{ color: GRAY_TEXT_DIM, fontSize: 20 }}>▾</span>
                      </div>
                    </div>
                    {/* Profe opcional */}
...
/* ─── Scene 2: Crear WOD (450–750, 10s) — TargetSelector + WOD de CrossFit ─── */
...
const SceneCrearRutina: React.FC = () => {
  ...
  const titleText = typewriter("Fran", frame, titleStartFrame, 4);

  const contentStartFrame = 160;
  // Typed content with markdown headings and bullets — CrossFit WOD
  const fullContent = [
    { type: "h2", text: "WARM UP" },
    { type: "li", text: "400m run" },
    { type: "li", text: "10 air squats, 10 push ups" },
    { type: "h2", text: "STRENGTH" },
    { type: "p", text: "Back Squat — 5×5 @ 75%" },
    { type: "h2", text: "METCON — FOR TIME" },
    { type: "p", text: "21-15-9 reps:" },
    { type: "li", text: "Thrusters 43kg" },
    { type: "li", text: "Pull ups" },
  ];
      ...
      <PhoneFrame>
        ...
        >
          {!showEditor ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10, height: "100%" }}>
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          background: isActive ? "rgba(126,217,87,0.10)" : INPUT_BG,
                          fontFamily: body.fontFamily,
                          fontWeight: 500,
                          fontSize: 14,
              ...
              <div>
                ...
                <div style={{ background: INPUT_BG, border: `1px solid ${titleText ? BRAND_BORDER_DIM : INPUT_BORDER}`, padding: "10px 14px", fontFamily: heading.fontFamily, fontWeight: 700, fontSize: 22, color: titleText ? "white" : GRAY_TEXT_DIM, minHeight: 46, display: "flex", alignItems: "center" }}>
                  {titleText || "Título (ej: WOD, Fuerza, Upper Body...)"}
              ...
              <div style={{ flex: 1, display: "flex", flexDirection: "column", minHeight: 0 }}>
                ...
                <div style={{ flex: 1, background: INPUT_BG, border: `1px solid ${INPUT_BORDER}`, borderTop: "none", padding: "10px 14px", overflow: "hidden" }}>
                  {frame < contentStartFrame ? (
                    <span style={{ fontFamily: body.fontFamily, fontSize: 18, color: GRAY_TEXT_DIM }}>Escribi el WOD aca...</span>
                  ) : (
            ...
            /* Saved — SOLO la card, sin header "WODs" ni botón "+ Nuevo WOD" */
            <div style={{ display: "flex", flexDirection: "column", alignItems: "stretch", justifyContent: "center", height: "100%" }}>
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 10, borderBottom: `1px solid ${PANEL_BORDER}`, paddingBottom: 10, flexWrap: "wrap" }}>
                  ...
                  <span style={{ fontFamily: heading.fontFamily, fontWeight: 700, fontSize: 20, color: "white" }}>Fran</span>
                  <span style={{ padding: "3px 10px", background: "rgba(126,217,87,0.10)", border: "1px solid rgba(126,217,87,0.20)", fontFamily: heading.fontFamily, fontWeight: 700, fontSize: 15, letterSpacing: "0.1em", color: BRAND }}>
                    Tomás López
                  </span>
                </div>
                <div style={{ display: "flex", flexDirection: "column", gap: 3 }}>
                  <div style={{ fontFamily: heading.fontFamily, fontWeight: 700, fontSize: 15, letterSpacing: "0.1em", color: BRAND, textTransform: "uppercase" }}>STRENGTH</div>
                  <div style={{ fontFamily: body.fontFamily, fontSize: 16, color: GRAY_TEXT }}>Back Squat — 5×5 @ 75%</div>
                  <div style={{ fontFamily: heading.fontFamily, fontWeight: 700, fontSize: 15, letterSpacing: "0.1em", color: BRAND, textTransform: "uppercase", marginTop: 4 }}>METCON — FOR TIME</div>
                  <div style={{ fontFamily: body.fontFamily, fontSize: 16, color: GRAY_TEXT }}>21-15-9 reps:</div>
                  <div style={{ fontFamily: body.fontFamily, fontSize: 16, color: GRAY_TEXT }}>· Thrusters 43kg</div>
                  <div style={{ fontFamily: body.fontFamily, fontSize: 16, color: GRAY_TEXT }}>· Pull ups</div>
                </div>
              </div>
            </div>
          )}
...
/* ─── Scene 3: Alumno ve el WOD (660–840, 6s) ─── */
    ...
    <AbsoluteFill style={{ transform, opacity, overflow: "hidden" }}>
      <PhoneFrame>
        ...
        >
          ...
          >
            <div style={{ padding: "14px 18px", borderBottom: `1px solid rgba(126,217,87,0.15)` }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <span
                  style={{
                    display: "inline-block",
            ...
            >
              <div style={{ fontFamily: heading.fontFamily, fontWeight: 700, fontSize: 15, letterSpacing: "0.1em", color: BRAND, textTransform: "uppercase" }}>STRENGTH</div>
              <div style={{ color: GRAY_TEXT, fontSize: 18 }}>Back Squat — 5×5 @ 75%</div>
              <div style={{ fontFamily: heading.fontFamily, fontWeight: 700, fontSize: 15, letterSpacing: "0.1em", color: BRAND, textTransform: "uppercase", marginTop: 6 }}>METCON — FOR TIME</div>
              <div style={{ color: GRAY_TEXT, fontSize: 18 }}>21-15-9 reps:</div>
              <div style={{ color: GRAY_TEXT, fontSize: 18 }}>· Thrusters 43kg</div>
              <div style={{ color: GRAY_TEXT, fontSize: 18, opacity: 0.7 }}>· Pull ups</div>
            </div>
          </div>
                ...
                >
                  <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ fontFamily: heading.fontFamily, fontWeight: 700, fontSize: 12, letterSpacing: "0.15em", color: `rgba(126,217,87,0.8)`, textTransform: "uppercase", marginTop: 2 }}>{c.badge}</div>
                    </div>
                  </div>
                  ...
                  {isTica ? (
                    codeVisible ? (
                      <div style={{ display: "flex", flexDirection: "column", gap: 8, opacity: codeOpacity, transform: `scale(${codeScale})` }}>
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", background: "black", border: `1px solid rgba(126,217,87,0.4)`, padding: "14px 16px" }}>
            ...
            {showLookupCard && (
              ...
              >
                ...
                <div style={{ display: "flex", gap: 10, justifyContent: "flex-end" }}>
                  <div style={{ padding: "10px 16px", border: `1px solid rgba(126,217,87,0.5)`, background: `rgba(126,217,87,0.1)`, color: BRAND, fontFamily: heading.fontFamily, fontWeight: 700, fontSize: 18, letterSpacing: "0.1em", textTransform: "uppercase" }}>
                    Denegar
                  </div>
                  <div style={{ position: "relative" }}>
                    <div
...
const ScenePagos: React.FC = () => {
  ...
  const students = [
    ...
    { name: "Mateo Ruiz", badge: "Atrasado 3 días", badgeBg: "rgba(126,217,87,0.08)", badgeBorder: "rgba(126,217,87,0.3)", badgeColor: BRAND, sub: "Próximo pago 22/04/2026" },
  ];
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(126,217,87,0.30) 0%, rgba(126,217,87,0.08) 40%, transparent 65%)",
          filter: "blur(180px)",
          pointerEvents: "none",
        }}
      />
      ...
      <div style={{ transform: `scale(${logoScale})`, opacity: logoOpacity, position: "relative" }}>
        <Img src={staticFile("logos/rompiendo-limites.png")} style={{ width: 800, height: "auto" }} />
      </div>
...
export const RompiendoLimitesPromo: React.FC = () => {
  return (

...
/* ─── Palette ─── */
const BRAND = "#ff3873";
const BRAND_DIM = "rgba(255,56,115,0.15)";
const BRAND_BORDER = "rgba(255,56,115,0.5)";
const BRAND_BORDER_DIM = "rgba(255,56,115,0.3)";
const BG = "#000000";
    ...
    <AbsoluteFill style={{ pointerEvents: "none" }}>
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(255,56,115,0.22) 0%, rgba(255,56,115,0.05) 40%, transparent 65%)",
          filter: "blur(160px)",
        }}
      />
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(255,56,115,0.12) 0%, transparent 70%)",
          filter: "blur(100px)",
        }}
      />
    </AbsoluteFill>
  ...
  return (
    ...
    >
      <div style={{ transform: `scale(${logoScale})`, opacity: logoOpacity }}>
        <Img src={staticFile("logos/mila-fit.png")} style={{ width: 700, height: "auto" }} />
      </div>
...
const SceneAltaUsuario: React.FC = () => {
  ...
  const emailAText = typewriter("carla.mendez@mila.fit", frame, 65, 3);
  ...
  const emailBText = typewriter("tomas.lopez@mila.fit", frameBLocal, 52, 3);
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          background: isActive ? "rgba(255,56,115,0.10)" : INPUT_BG,
                          fontFamily: body.fontFamily,
                          fontWeight: 500,
                          fontSize: 14,
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "stretch", justifyContent: "center", height: "100%" }}>
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 10, borderBottom: `1px solid ${PANEL_BORDER}`, paddingBottom: 10, flexWrap: "wrap" }}>
                  ...
                  <span style={{ padding: "3px 10px", background: "rgba(255,56,115,0.10)", border: "1px solid rgba(255,56,115,0.20)", fontFamily: heading.fontFamily, fontWeight: 700, fontSize: 15, letterSpacing: "0.1em", color: BRAND }}>
                    Tomás López
                  </span>
                </div>
    ...
    <AbsoluteFill style={{ transform, opacity, overflow: "hidden" }}>
      <PhoneFrame>
        ...
        >
          ...
          >
            <div style={{ padding: "14px 18px", borderBottom: "1px solid rgba(255,56,115,0.15)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <span
                  style={{
                    display: "inline-block",
                ...
                >
                  <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ fontFamily: heading.fontFamily, fontWeight: 700, fontSize: 12, letterSpacing: "0.15em", color: "rgba(255,56,115,0.8)", textTransform: "uppercase", marginTop: 2 }}>{c.badge}</div>
                    </div>
                  </div>
                  ...
                  {isTica ? (
                    codeVisible ? (
                      <div style={{ display: "flex", flexDirection: "column", gap: 8, opacity: codeOpacity, transform: `scale(${codeScale})` }}>
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", background: "black", border: "1px solid rgba(255,56,115,0.4)", padding: "14px 16px" }}>
            ...
            {showLookupCard && (
              <div
                style={{
                  opacity: cardOpacity,
                  transform: `translateY(${cardY}px)`,
                  border: "1px solid rgba(255,56,115,0.3)",
                  background: "rgba(255,56,115,0.05)",
                  padding: "14px 16px",
                  display: "flex",
                  flexDirection: "column",
                  gap: 10,
              ...
              >
                ...
                <div style={{ display: "flex", gap: 10, justifyContent: "flex-end" }}>
                  <div style={{ padding: "10px 16px", border: "1px solid rgba(255,56,115,0.5)", background: "rgba(255,56,115,0.1)", color: BRAND, fontFamily: heading.fontFamily, fontWeight: 700, fontSize: 18, letterSpacing: "0.1em", textTransform: "uppercase" }}>
                    Denegar
                  </div>
                  <div style={{ position: "relative" }}>
                    <div
...
const ScenePagos: React.FC = () => {
  ...
  const students = [
    ...
    { name: "Mateo Ruiz", badge: "Atrasado 3 días", badgeBg: "rgba(255,56,115,0.08)", badgeBorder: "rgba(255,56,115,0.3)", badgeColor: BRAND, sub: "Próximo pago 22/04/2026" },
  ];
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(255,56,115,0.30) 0%, rgba(255,56,115,0.08) 40%, transparent 65%)",
          filter: "blur(180px)",
          pointerEvents: "none",
        }}
      />
      ...
      <div style={{ transform: `scale(${logoScale})`, opacity: logoOpacity, position: "relative" }}>
        <Img src={staticFile("logos/mila-fit.png")} style={{ width: 800, height: "auto" }} />
      </div>
...
export const MilaFitPromo: React.FC = () => {
  return (

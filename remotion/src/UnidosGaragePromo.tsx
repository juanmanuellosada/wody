...
/* ─── Palette ─── */
const BRAND = "#E31414";
const BRAND_DIM = "rgba(227,20,20,0.15)";
const BRAND_BORDER = "rgba(227,20,20,0.5)";
const BRAND_BORDER_DIM = "rgba(227,20,20,0.3)";
const BG = "#000000";
...
/* ─── Timing constants (must sum to 1560) ─── */
// 90+360+300+150+210+180+120+150 = 1560
const INTRO_START = 0;
const INTRO_DUR = 90;
const ALTA_START = 90;
const ALTA_DUR = 360;
...
const BENEF_DUR = 180;
const PAGO_START = 1290;
const PAGO_DUR = 120;
const CTA_START = 1410;
const CTA_DUR = 150;
    ...
    <AbsoluteFill style={{ pointerEvents: "none" }}>
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(227,20,20,0.22) 0%, rgba(227,20,20,0.05) 40%, transparent 65%)",
          filter: "blur(160px)",
        }}
      />
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(227,20,20,0.12) 0%, transparent 70%)",
          filter: "blur(100px)",
        }}
      />
    </AbsoluteFill>
  ...
  return (
    ...
    >
      <div style={{ transform: `scale(${logoScale})`, opacity: logoOpacity }}>
        <Img src={staticFile("logos/unidos-logo-completo.png")} style={{ width: 700, height: "auto" }} />
      </div>
...
const SceneAltaUsuario: React.FC = () => {
  ...
  const emailAText = typewriter("carla.mendez@unidosgarage.com", frame, 65, 3);
  ...
  const emailBText = typewriter("tomas.lopez@unidosgarage.com", frameBLocal, 52, 3);
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          background: isActive ? BRAND_DIM : INPUT_BG,
                          fontFamily: body.fontFamily,
                          fontWeight: 500,
                          fontSize: 14,
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "stretch", justifyContent: "center", height: "100%" }}>
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 10, borderBottom: `1px solid ${PANEL_BORDER}`, paddingBottom: 10, flexWrap: "wrap" }}>
                  ...
                  <span style={{ padding: "3px 10px", background: BRAND_DIM, border: `1px solid rgba(227,20,20,0.20)`, fontFamily: heading.fontFamily, fontWeight: 700, fontSize: 15, letterSpacing: "0.1em", color: BRAND }}>
                    Tomás López
                  </span>
                </div>
...
/* ─── Scene 3: Alumno ve el WOD (750–900, 5s) ─── */
    ...
    <AbsoluteFill style={{ transform, opacity, overflow: "hidden" }}>
      <PhoneFrame>
        ...
        >
          ...
          >
            <div style={{ padding: "14px 18px", borderBottom: `1px solid rgba(227,20,20,0.15)` }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <span
                  style={{
...
/* ─── Scene 4: Cronómetros (900–1110, 7s) ─── */
                ...
                >
                  <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ fontFamily: heading.fontFamily, fontWeight: 700, fontSize: 12, letterSpacing: "0.15em", color: `rgba(227,20,20,0.8)`, textTransform: "uppercase", marginTop: 2 }}>{c.badge}</div>
                    </div>
                  </div>
                  ...
                  {isTica ? (
                    codeVisible ? (
                      <div style={{ display: "flex", flexDirection: "column", gap: 8, opacity: codeOpacity, transform: `scale(${codeScale})` }}>
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", background: "black", border: `1px solid rgba(227,20,20,0.4)`, padding: "14px 16px" }}>
...
const ScenePagos: React.FC = () => {
  ...
  const students = [
    ...
    { name: "Mateo Ruiz", badge: "Atrasado 3 días", badgeBg: BRAND_DIM, badgeBorder: BRAND_BORDER_DIM, badgeColor: BRAND, sub: "Próximo pago 22/04/2026" },
  ];
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(227,20,20,0.30) 0%, rgba(227,20,20,0.08) 40%, transparent 65%)",
          filter: "blur(180px)",
          pointerEvents: "none",
        }}
      />
      ...
      <div style={{ transform: `scale(${logoScale})`, opacity: logoOpacity, position: "relative" }}>
        <Img src={staticFile("logos/unidos-logo-completo.png")} style={{ width: 800, height: "auto" }} />
      </div>
...
export const UnidosGaragePromo: React.FC = () => {
  return (

...
interface PersonalLeadRejectedEmailProps {
  contactName: string;
  rejectionReason?: string;
}

export function PersonalLeadRejectedEmail({ contactName, rejectionReason }: PersonalLeadRejectedEmailProps) {
  ...
  return (
    <Html lang="es">
      <Head />
      <Preview>Respuesta sobre tu solicitud de Wody Personal</Preview>
      <Body
        style={{
      ...
      >
        ...
        >
          ...
          <Text style={{ fontSize: "15px", color: "#3f3f46", lineHeight: "1.6", margin: "0 0 12px 0" }}>
            Gracias por tu interés en Wody Personal. Luego de revisar tu solicitud, por el momento no podemos avanzar con el acceso.
          </Text>

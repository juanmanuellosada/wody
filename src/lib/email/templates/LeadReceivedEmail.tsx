...
interface LeadReceivedEmailProps {
  contactName: string;
  gymName: string;
}

export function LeadReceivedEmail({ contactName, gymName }: LeadReceivedEmailProps) {
  ...
  return (
    <Html lang="es">
      <Head />
      <Preview>Recibimos tu consulta sobre {gymName}</Preview>
      <Body
        style={{
      ...
      >
        ...
        >
          ...
          <Text style={{ fontSize: "15px", color: "#3f3f46", lineHeight: "1.6", margin: "0 0 12px 0" }}>
            Recibimos tu consulta para dar de alta <strong>{gymName}</strong> en Wody.
          </Text>

          <Text style={{ fontSize: "15px", color: "#3f3f46", lineHeight: "1.6", margin: "0 0 24px 0" }}>
            Nuestro equipo va a revisar tu solicitud y te vamos a contactar en las próximas <strong>48 horas hábiles</strong>.
          </Text>

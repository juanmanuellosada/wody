    ...
    <main className="min-h-screen flex flex-col bg-[#0A0A0F] text-white overflow-hidden">
      ...
      >
        <svg width={22} height={22} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          ...
          <path d="M12 2C6.477 2 2 6.477 2 12c0 1.89.525 3.66 1.438 5.168L2 22l4.832-1.438A9.955 9.955 0 0012 22c5.523 0 10-4.477 10-10S17.523 2 12 2zm0 18a7.963 7.963 0 01-4.106-1.14l-.294-.176-2.866.852.852-2.866-.176-.294A7.963 7.963 0 014 12c0-4.411 3.589-8 8-8s8 3.589 8 8-3.589 8-8 8z" />
        </svg>
